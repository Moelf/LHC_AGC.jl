...
tt_tree = LazyTree(joinpath(LHC_AGC.BASE_PATH[], "00DF0A73-17C2-E511-B086-E41D2D08DE30.root"), "events");
...
# ╔═╡ a833773a-812f-44bc-b272-4bec72af05a2
begin
	# this is a lazy generator, evident since it has 0 allocation
	_c = @time (count(>(25), x) for x in tt_tree.jet_pt)
	njet_hist_withcut = Hist1D(_c, 2:10)
end

# ╔═╡ 33b8830a-8365-4a37-ad12-180113101700
# but the loop over this generator is fully inferred, which means it's fast
...
begin
	...
	annotations!(L"m_t = 175 \mathrm{GeV}", position=(180, 20))
	current_figure()
end
